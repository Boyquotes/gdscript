...
# As educational and illustrational purpose, in this script the `find_child` way
# of getting nodes is used.
@onready var sign_up_form := $"/root/LoginRegister".find_child("SignUpForm")
@onready var sign_in_form := $"/root/LoginRegister".find_child("SignInForm")
@onready var first_name_input := $"/root/LoginRegister".find_child("FirstName")
@onready var last_name_input := $"/root/LoginRegister".find_child("LastName")
@onready var email_input := $"/root/LoginRegister".find_child("Email")
@onready var password_input := $"/root/LoginRegister".find_child("Password")
@onready var confirm_password_input := $"/root/LoginRegister".find_child("ConfirmPassword")
@onready var login_email_input := $"/root/LoginRegister".find_child("SignInEmail")
@onready var login_password_input := $"/root/LoginRegister".find_child("SignInPassword")
