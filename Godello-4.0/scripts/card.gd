...
var model : CardModel : get = get_model, set = set_model
...
# warning-ignore:return_value_discarded
	Events.connect("card_dropped",Callable(self,"_on_card_dropped"))
# warning-ignore:return_value_discarded
	Events.connect("list_dragged",Callable(self,"_on_list_dragged"))
# warning-ignore:return_value_discarded
	Events.connect("list_dropped",Callable(self,"_on_list_dropped"))
...
func _unhandled_input(event):
	...
	if event is InputEventMouseButton and is_dragged:
		Events.emit_signal("card_dropped", DragUtils._get_drag_data(self, model), is_dragged_to_list)
...
func _on_card_dropped(_drop_data, _new_owner):
