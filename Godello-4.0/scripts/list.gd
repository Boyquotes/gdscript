...
#var model : ListModel : get = get_model, set = _set_model
...
#	set (_model):
#		return null
#_model : ListModel, shallow_update := false
...
# warning-ignore:return_value_discarded
	DataRepository.connect("card_created",Callable(self,"_on_card_created"))
# warning-ignore:return_value_discarded
...
func _get_drag_data(_pos):
	var list = ListDragPreview.instantiate()
...
func _can_drop_data(mouse_pos, data):
